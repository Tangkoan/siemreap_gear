...
<!-- Primary Color -->
<div>
    <label for="{{ $modePrefix }}_primary_color" class="block text-sm font-medium text-defalut">Primary Color (Icons, Buttons)</label>
...
<div x-show="{{ $mode }}.bg_type === 'color'" class="pt-2" x-transition>
    <label for="{{ $modePrefix }}_bg_color" class="block text-sm font-medium text-defalut">Choose Background Color</label>
...
<div x-show="{{ $mode }}.card_type === 'gradient'" class="pt-2 space-y-4" x-transition>
    <div>
        <label for="{{ $modePrefix }}_card_color1_grad" class="block text-sm font-medium text-defalut">Gradient Color 1 (Start)</label>
     ...
     <div>
        <label for="{{ $modePrefix }}_card_color2_grad" class="block text-sm font-medium text-defalut">Gradient Color 2 (End)</label>
    ...
    <div>
         <label for="{{ $modePrefix }}_card_gradient_dir" class="block text-sm font-medium text-defalut">Gradient Direction</label>
