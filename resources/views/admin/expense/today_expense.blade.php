...
@section('admin')
                                    ...
                                    {{-- <div class="lg:col-span-full card-bg rounded-lg shadow-xl p-6 transition-all duration-300 transform "> --}}
                                        ...
                                        <div class="flex justify-between">
                                            <h2 class="text-xl font-semibold text-default mb-6 flex items-center">
                                                ...
                                                <div class="px-2">Today Expense</div>
                                            </h2>
                                                    ...
                                                    <div class="w-full max-w-sm min-w-[200px] relative">
                                                        <div class="relative">
                                                            <input
                                                                ...
                                                                placeholder="Search for Today Details" id="search" name="search" type="text" />
    ...
    $expense = App\Models\Expense::where('date', $date)->sum('amount');
                                            ...
                                            <h4 class="dark:text-white text-2xl text-center text-gray-900 py-5">
                                                Today Total : ${{ $expense }}
                                            </h4>
                                            <div
                                            div class="table-wrapper overflow-y-auto max-h-[370px]">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($today as $key => $item)
                                                            ...
                                                            <tr class="hover:bg-slate-50 border-b border-slate-200">
                                                                ...
                                                                <td class="p-4 py-5">
                                                                    <p class="text-sm text-slate-500">{{ $item->month }}</p>
                                                                </td>
                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function () {
                                    function fetchData(page = 1) {
                                        ...
                                        $.ajax({
                                            url: "{{ route('search.today') }}?page=" + page,
                                            type: "GET",
                                            data: {
                                                search: query,
                                                perPage: perPage
