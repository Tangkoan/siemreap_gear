        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="card-bg p-6 rounded-lg shadow-md transition-colors duration-300">
                ...
                <a href="#" class="text-sm text-blue-500 hover:underline flex items-center mt-3">
                    More Info
                    <svg class="icon h-4 w-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"
            ...
            <div class="card-bg p-6 rounded-lg shadow-md transition-colors duration-300">
                ...
                <p class="text-4xl font-bold text-teal-600"><span data-plugin="counterup">{{ count($completeorder) }}</span>
                </p>
            ...
            <div class="card-bg p-6 rounded-lg shadow-md transition-colors duration-300">
                ...
                <p class="text-4xl font-bold text-red-600"><span data-plugin="counterup">{{ count($pendingorder) }}</span>
                </p>
                ...
                <table class="min-w-full card-bg text-default">
                    <thead>
                        <tr class="border-b border-gray-200 dark:border-gray-700">
                            <th
                                class="py-3 px-4 text-left text-xs font-semibold text-table-header-text uppercase tracking-wider">
                                Sale Id</th>
                            <th
                                class="py-3 px-4 text-left text-xs font-semibold text-table-header-text uppercase tracking-wider">
                                Customer</th>
