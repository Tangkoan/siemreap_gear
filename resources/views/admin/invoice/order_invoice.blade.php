...
<body>
    ...
    <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
        <tr>
            <td valign="top">
                ...
                <h2 style="color: green; font-size: 26px;"><strong>SR GEAR</strong></h2>
            </td>
            <td align="right">
                <pre class="font">
               SR GEAR<br>
        ...
        <tr>
            <td>
                <p class="font" style="margin-left: 20px;">
                    ...
                    <strong>Address: {{ $order->customer->address }} </strong>  <br>
            ...
            <td>
                <p class="font">
                    <h3><span style="color: green;">Invoice:</span> # {{ $order->invoice_no }} </h3>Add commentMore actions
        ...
        <tbody>
            ...
            @foreach($orderItem as $item)
                <tr class="font">
                    ...
                    <td align="center"> {{ $item->product->product_name }} </td>Add commentMore actions
    ...
    <table width="100%" style=" padding:0 10px 0 10px;">
        <tr>
            <td align="right">
                <h2><span style="color: green;">Subtotal:</span>$ {{ $order->total }} </h2>Add commentMore actions
