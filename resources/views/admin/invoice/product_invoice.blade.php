                                                    ...
                                                    <div id="printPopup" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">
                                                        <div id="popupContent"
                                                            ...
                                                            <form class="px-3" method="post" action="{{ route('category.store') }}">
                                                                ...
                                                                <select name="customer_id" id="customer_id" class="w-full p-2 border rounded mb-4">
                                                                ...
                                                                <input type="text" id="printName" class="w-full p-2 border rounded mb-4" placeholder="Enter your name">

                                                                <label class="block mb-2">Quantity:</label>
                                                                <input type="number" id="printQuantity" class="w-full p-2 border rounded mb-4"
                                                                ...
                                                                <div class="flex justify-end">
                                                                    <button onclick="closePrintPopup()"
                                                                        class="bg-gray-300 text-black px-4 py-2 rounded mr-2">Cancel</button>
                                                                    <button onclick="submitPrint()" class="bg-blue-500 text-white px-4 py-2 rounded">Print</button>
                                                                </div>
