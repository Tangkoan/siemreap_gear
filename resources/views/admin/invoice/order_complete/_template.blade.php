{{-- File: resources/views/admin/invoice/order_complete/_template.blade.php --}}
...
<style>
        ...
        .invoice-title h1, .invoice-title h2 {
            color: #28a745; /* ពណ៌បៃតងសម្រាប់ Complete */
        }

        /* ✅ កែពណ៌សម្រាប់ Due/Balance ព្រោះវា = 0 */
        .due-amount, .due-amount td {
        ...
        *, *::before, *::after {
        ...
        .company-info-box, .invoice-info-box {
            ...
            padding: 8px 12px;
            width: 49%; /* ✅ Adjust width slightly */
            font-size: 10pt;
            border-radius: 4px;
        }
        .info-table {
        ...
        .info-table td {
            padding: 2.5px 2px; /* ✅ Adjust padding */
            vertical-align: top;
        }
        .info-table td.label {
            width: 1%;
        ...
        .info-table td.value {
            word-break: break-word; /* ✅ Crucial for breaking long text like address */
        }
        .info-table td.value strong {
            color: #333333; /* Ensure strong text is dark */
        }
        ...
        .main-table td.description {
            text-align: left;
            word-break: break-word; /* Allow description to wrap nicely */
        }
        ...
        .terms-box p {
            ...
            word-break: break-word; /* ✅ Allow terms to wrap nicely */
        }
        .totals-box {
            flex-basis: 33%;
        }
        ...
        .due-amount, .due-amount td { /* ✅ Target the row and its cells */
            color: #ffffff !important;
        ...
        @media print {
            ...
            .page {
                margin: 0; border: initial; border-radius: initial;
...
<div class="page">
    ...
    {{-- HTML ផ្សេងៗទៀតគឺដូចគ្នាទាំងអស់ មិនចាំបាច់កែទេ --}}
