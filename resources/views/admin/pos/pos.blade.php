...
@section('admin')
    ...
    <div class="flex flex-col lg:flex-row gap-4 font-sans no-print w-full  p-4">
        ...
        <div class="lg:w-3/5 xl:w-2/3 bg-white/80 dark:bg-gray-900/80 p-4 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col h-[calc(100vh-85px)]">
            {{-- Header & Search --}}
        ...
        <div class="lg:w-2/5 xl:w-1/3 bg-white/80 dark:bg-gray-900/80 p-4 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col h-[calc(100vh-85px)]">
