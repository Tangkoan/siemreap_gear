    ...
    $allcart = Cart::content();
                    ...
                    <form method="POST" action="{{ url('/store-sell') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="customer_id"
                                class="block mb-1 font-medium text-gray-800 dark:text-white">Customer</label>
            ...
            <form method="POST" action="/add-cart" id="form-${product.id}">
                ...
                <div class="bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg transform transition duration-200
                    ...
                    ${disabled ? '' : `onclick="document.getElementById('form-${product.id}').submit();"`}
