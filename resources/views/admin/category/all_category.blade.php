            ...
            <div class="lg:col-span-full p-0">
                <div class="flex justify-between">
                    <h2 class=" mb-6 flex items-center">
                        ...
                        <div class="px-2 text-3xl font-bold text-defalut">{{ __('messages.category') }}</div>
                    </h2>
                    <div>
                        <div>
                    ...
                    <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
                        ...
                        <div class="ml-3">
                            <div class="w-full max-w-sm min-w-[200px] relative">
                                <div class="relative">
                                    <input class=" card-dynamic-bg text-defalut   w-full pr-11 h-10 pl-3 py-2  placeholder:text-slate-400  text-sm border-primary  rounded transition duration-200 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md" placeholder="{{ __('messages.search_for_category') }}" id="search" name="search" type="text" />
