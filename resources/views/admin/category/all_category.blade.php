  ...
  <div class="container mx-auto p-6">
    ...
    <div class="lg:col-span-full card-bg rounded-lg shadow-xl p-6 transition-all duration-300 transform ">
      ...
      <div>
        ...
        <button type="button"
        class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent color-primary text-white focus:outline-hidden  disabled:opacity-50 disabled:pointer-events-none">
      ...
      <div class="table-wrapper overflow-y-auto max-h-[450px]">
        ...
        <thead class="bg-slate-50">
          <tr>
          <th class="p-4 sticky top-0 bg-slate-50 z-10 border-b border-slate-200">N<sup>0</sup></th>
          <th class="p-4 sticky top-0 bg-slate-50 z-10 border-b border-slate-200">Name</th>
          <th class="p-4 sticky top-0 bg-slate-50 z-10 border-b border-slate-200">Action</th>
          </tr>
        </thead>
        <tbody>
        ...
        <td class="p-4 py-5 text-sm text-black">{{ $item->category_name }}</td>
