            ...
            <div
                ...
                <form method="post" action="{{ route('category.store') }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="category_name" name="category_name"  class="w-full py-2.5 px-4 rounded-md border border-gray-300 dark:border-gray-600
                                           ...
                                           focus:outline-none focus:ring-2 focus:bg-primary focus:border-transparent
                    ...
                    <div class="flex justify-end mt-6">
                        <button type="submit"
                            class="bg-primary text-white font-bold py-3 px-6 rounded-md shadow-lg transition-colors duration-200">
                            {{ __('messages.save') }}
                        </button>
                    </div>
                </form>
