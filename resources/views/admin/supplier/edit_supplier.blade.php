        ...
        <div class="grid grid-cols-1">
            ...
            <div
                ...
                <h2 class="text-xl text-defalut mb-6 flex items-center">
                    ...
                    <div class="px-2">{{ __('messages.edit_supplier') }}</div>
                </h2>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" value="{{ $supplier->name }}"
                                        class="w-full py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-md card-dynamic-bg text-defalut focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                    @error('name')
