                    ...
                    <div class="table-wrapper overflow-y-auto max-h-[500px]">
                        <table class="w-full text-left table-auto min-w-max">
                            <thead class="bg-slate-50 dark:bg-gray-800">
                                <tr>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{!! __('messages.table_no') !!}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.name') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.email') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.phone') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.notes') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.table_action') }}</p></th>
                                </tr>
                            </thead>
                            <tbody>
                                </tbody>
