    ...
    <div class="grid grid-cols-1"> 
        ...
        <div class="lg:col-span-full card-bg rounded-lg shadow-xl p-6 transition-all duration-300 transform">
            <h2 class="text-xl font-semibold text-default mb-6 flex items-center">
                ...
                <div class="px-2">Edit Employee</div>
            </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone" name="phone" required value="{{ $employee->phone }}"
                            ...
                            <div class="mb-2">
                                ...
                                <img id="image_preview" src="{{ asset($employee->image) }}" alt="Image Preview" class="mt-2 rounded-md max-h-40"/>
                                @error('image')
                                    <span class="text-danger"> {{ $message }} </span>
                                @enderror
                            </div>
