        ...
        <div class="relative w-full max-w-xl transform rounded-xl bg-white dark:bg-slate-800 shadow-2xl border dark:border-slate-700">
            <form id="addProductForm" novalidate>
                ...
                <div class="p-6 max-h-[75vh] overflow-y-auto">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="product_name" id="product_name" class="mt-1 block w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 sm:text-sm dark:bg-slate-700" placeholder="{{ __('messages.product_name') }}">
                ...
                <div class="flex justify-end gap-x-3 p-4 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-700">
                    <button id="cancel-add-product" type="button" class="px-4 py-2 bg-gray-200 text-slate-800 rounded-md hover:bg-slate-200 focus:outline-none dark:bg-slate-700 dark:text-white dark:hover:bg-slate-600">{{ __('messages.cancel') }}</button>
                    <button id="save-product-btn" type="submit" class="inline-flex items-center justify-center px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none ">
