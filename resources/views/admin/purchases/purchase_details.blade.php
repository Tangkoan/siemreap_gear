                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <label class="block text-gray-400 text-sm font-medium mb-1">
                                                    Supplier Name : <span>{{ $purchase->supplier->name }}</span>
                                                </label>

                                                <label class="block text-gray-400 text-sm font-medium mb-1">
                                                    Email : <span>{{ $purchase->supplier->email ?? 'null' }}</span>
                                                </label>

                                                <label class="block text-gray-400 text-sm font-medium mb-1">
                                                    Phone : <span>{{ $purchase->supplier->phone }}</span>
                                                </label>

                                                <label class="block text-gray-400 text-sm font-medium mb-1">
                                                    Purchase Date : <span>{{ $purchase->purchase_date }}</span>
                                                </label>
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <label class="block text-gray-400 text-sm font-medium mb-1">
                                                    Purchase Invoice : <span>{{ $purchase->invoice_no }}</span>
                                                </label>

                                                <label for="product_name" class="block text-gray-400 text-sm font-medium mb-1">
                                                    Payment Status : <span>{{ $purchase->payment_status }}</span>
                                                </label>

                                                <label for="product_name" class="block text-gray-400 text-sm font-medium mb-1">
                                                    Paid Amount : <span>{{ $purchase->pay }}</span>
                                                </label>

                                                <label for="product_name" class="block text-gray-400 text-sm font-medium mb-1">
                                                    Due Amount : <span>{{ $purchase->due }}</span>
                                                </label>
