                ...
                <form id="myForm" method="post" action="{{ route('role.permission.update', $role->id) }}">
                    ...
                    <div class="mb-6">
                        <label class="block text-gray-700 text-sm font-medium mb-2">
                            Role Name:
                            <span class="text-red-500 text-xl">{{ $role->name }}</span>
                        </label>
                    </div>
                    ...
                    <div class="mb-6 flex items-center gap-3">
                        ...
                        <label for="checkAllPermissions" class="text-gray-700 text-sm">All Permissions</label>
                    </div>
                        ...
                        <fieldset class="mb-6 border border-gray-200 p-4 rounded-md">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                                @foreach ($permissions as $permission)
                                    <label for="perm_{{ $permission->id }}" class="flex items-center gap-2 text-gray-700 text-sm">
