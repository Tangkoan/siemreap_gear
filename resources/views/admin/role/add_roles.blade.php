    ...
    <div class="container mx-auto p-6">
        <div class="grid grid-cols-1">
            <div
                ...
                <h2 class="text-xl  text-deflaut mb-6 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                        ...
                        <div class="space-y-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name"  class="w-full py-2.5 px-4 border border-primary rounded-md card-dynamic-bg 
