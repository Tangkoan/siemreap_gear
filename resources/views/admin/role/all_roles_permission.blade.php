            ...
            <div class="lg:col-span-full p-0">
                <div class="flex justify-between">
                    <h2 class="text-xl text-default mb-6 flex items-center">
                        ...
                        <div class="px-2 text-3xl font-bold text-defalut">{{ __('messages.all_roles_permission') }}</div>
                    </h2>
                    <div>
                        ...
                        <table class="w-full text-left table-auto min-w-max">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class=" text-sm font-medium leading-none text-primary"></p></th>
