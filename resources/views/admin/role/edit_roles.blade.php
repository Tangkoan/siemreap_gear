                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="{{ $roles->name }}" type="text" id="name" name="name" required class="input-field-custom w-full py-2.5 px-4 border border-gray-700 rounded-md bg-gray-800 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent
