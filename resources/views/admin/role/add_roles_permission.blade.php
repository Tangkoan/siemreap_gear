...
@section('admin')
    ...
    <div class="container mx-auto p-6">
        <div class="grid grid-cols-1 ">
            <div class="dark:bg-gray-700 bg-white rounded-lg shadow-md p-6 transition-all duration-300">
                    ...
                    @foreach($permission_groups as $group)
                        ...
                        $permissions = App\Models\User::getpermissionByGroupName($group->group_name);
                                                                    ...
                                                                    <fieldset class="mb-6 border border-gray-200 p-4 rounded-md">
                                                                        <legend class="text-sm text-black font-semibold mb-4 dark:text-white">{{ $group->group_name }}</legend>
