                        ...
                        <table class="w-full text-left table-auto min-w-max">
                            <thead>
                                <tr class="bg-slate-50 dark:bg-gray-800">
                                    ...
                                    <th class="sticky top-0 p-4 border-b border-slate-200 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.image') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.name') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.email') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.phone') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 bg-slate-50 dark:bg-gray-800"><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.roles') }}</p></th>
