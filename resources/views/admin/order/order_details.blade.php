    ...
    $sl = 1;
                                                                        ...
                                                                        @foreach ($orderItem as $key => $item)
                                                                            <tr>
                                                                                ...
                                                                                <td class="border border-gray-300 px-2 py-1 text-center "> <img src="{{ asset($item->product->product_image) }}" style="width:50px; height: 40px; "> </td>
                                                                                <td class="border border-gray-300 px-2 py-1 text-center">{{ $item->product->product_name }}</td>
                                                                                ...
                                                                                <td class="border border-gray-300 px-2 py-1 text-center">{{ $item->product->selling_price * $item->quantity  }} $
                                                                                </td>
                                                                            </tr>
                                                                        @endforeach
                                                                    </tbody>
