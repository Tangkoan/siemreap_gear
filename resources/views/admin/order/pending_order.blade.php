            ...
            <div class="lg:col-span-full p-0">
                <div class="flex justify-between">
                    <h2 class="text-xl text-default mb-6 flex items-center">
                        ...
                        <div class="px-2 text-3xl font-bold text-defalut">{{ __('messages.pending_orders') }}</div>
                    </h2>
                    <div></div>
                </div>
                    ...
                    <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
                        <div>
                            <div class="flex items-center space-x-2">
                                ...
                                <select id="perPage" name="perPage" class="card-dynamic-bg text-defalut h-10 border rounded text-sm border-primary focus:outline-none focus:ring-1 focus:ring-slate-400">
                        ...
                        <div class="ml-3">
                            <div class="w-full max-w-sm min-w-[200px] relative">
                                <div class="relative">
                                    <input class="card-dynamic-bg text-defalut  w-full pr-11 h-10 pl-3 py-2  placeholder:text-slate-400 text-sm border border-primary rounded transition duration-200 ease focus:outline-none shadow-sm focus:shadow-md" placeholder="{{ __('messages.search') }}" id="search" name="search" type="text" />
                        ...
                        <table class="w-full text-left table-auto min-w-max">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-medium leading-none text-primary">{{ __('messages.customer_name') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-medium leading-none text-primary">{{ __('messages.order_date') }}</p></th>
                                    ...
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-medium leading-none text-primary">{{ __('messages.status') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-medium leading-none text-primary">{{ __('messages.order_type') }}</p></th>
