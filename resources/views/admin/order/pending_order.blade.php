                    ...
                    <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
                        ...
                        <div class="ml-3">
                            <div class="w-full max-w-sm min-w-[200px] relative">
                                <div class="relative">
                                    <input class="bg-white/80 dark:bg-gray-900/80 dark:text-white  w-full pr-11 h-10 pl-3 py-2  placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded transition duration-200 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md" placeholder="{{ __('messages.search') }}" id="search" name="search" type="text" />
                        ...
                        <table class="w-full text-left table-auto min-w-max">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.customer_name') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.order_date') }}</p></th>
                                    ...
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.status') }}</p></th>
                                    <th class="sticky top-0 p-4 border-b border-slate-200 "><p class="text-sm font-normal leading-none text-slate-500">{{ __('messages.order_type') }}</p></th>
