            ...
            <div class="lg:col-span-full card-bg rounded-lg shadow-xl p-6 transition-all duration-300 transform">
                ...
                <div>
                    <form method="post" action="{{ route('update.due') }}">
                        ...
                        <input class="text-black dark:text-gray-800" type="hidden" name="id" id="order_id" value="{{ $paydue->id }}">
                        <input class="text-black dark:text-gray-800" type="hidden" name="pay" id="pay" value="{{ $paydue->pay }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                            ...
                            <input type="number" min="0" step="0.01" value="{{ $paydue->due }}" id="due" name="due" required class="input-field-custom w-full py-2.5 px-4 border border-gray-700 rounded-md bg-gray-800 text-gray-200 
