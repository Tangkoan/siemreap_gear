                ...
                <div class="lg:col-span-full p-0">
                    <div class="flex justify-between">
                        <h2 class="text-xl font-semibold text-default mb-6 flex items-center">
                            ...
                            <div class="px-2">{{ __('messages.pending_due') }}</div>
                        </h2>
                        <div>
                            ...
                            <table class="w-full text-left table-auto min-w-max">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="px-2 sticky  top-0 dark:bg-gray-800 p-4 border-b border-slate-200 bg-slate-50">
                                            <p class="px-4 text-sm font-normal leading-none text-slate-500">
                                                {{ __('messages.total') }}
                                            </p>
                                        </th>
                                        ...
                                        <th class="px-4 sticky top-0 dark:bg-gray-800 p-4 border-b border-slate-200 bg-slate-50">
                                            <p class="px-4 text-sm font-normal leading-none text-slate-500">
                                                {{ __('messages.due') }}
                                            </p>
                                        </th>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                function fetchData(page = 1) {
                    ...
                    $.ajax({
                        url: "{{ route('search.pending_due') }}?page=" + page,
                        type: "GET",
                        data: {
                            search: query,
                            perPage: perPage
