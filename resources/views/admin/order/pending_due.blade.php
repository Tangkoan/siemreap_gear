                            ...
                            <table class="w-full text-left table-auto min-w-max">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="px-2 sticky  top-0 dark:bg-gray-900 p-4 border-b border-slate-200 bg-slate-50">
                                        ...
                                        <th class="px-4 sticky top-0 dark:bg-gray-900 p-4 border-b border-slate-200 bg-slate-50">
                                            <p class="px-4 text-sm font-normal leading-none text-slate-500">
                                                {{ __('messages.due') }}
                                            </p>
                                        </th>
