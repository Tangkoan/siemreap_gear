                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="product_name" required value="{{ $product->product_name }}"
                                    class="w-full py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-md card-dynamic-bg text-defalut focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            </div>
