                    ...
                    <form method="post" action="{{ route('product.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <input type="hidden" id="product_code" name="product_code" required value="{{ $product->product_code }}"
                                ...
                                <div class="mb-2">
                                    ...
                                    <img id="image_preview" src="{{ asset($product->product_image) }}" alt="Image Preview" class="mt-2 rounded-md max-h-40" />
                                    @error('image')
                                        <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" min="0" step="0.01" id="selling_price" name="selling_price" value="{{ $product->selling_price }}"
                                        class="input-field-custom w-full py-2.5 px-4 border border-gray-700 rounded-md bg-gray-800 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                ...
                                <div>
                                    ...
                                    <input type="number" min="0" step="0.01" id="buying_price" name="buying_price" value="{{ $product->buying_price }}"
                                        class="input-field-custom w-full py-2.5 px-4 border border-gray-700 rounded-md bg-gray-800 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                ...
                                <div>
                                    ...
                                    <input type="number" min="0" step="0.01" id="cost" name="cost" value="{{ $product->cost }}"
                                        class="input-field-custom w-full py-2.5 px-4 border border-gray-700 rounded-md bg-gray-800 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="product_store" name="product_store" required value="{{ $product->product_store }}"
                                        class="input-field-custom w-full py-2.5 px-4 border border-gray-700 rounded-md bg-gray-800 text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                </div>
