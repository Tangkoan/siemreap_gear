            ...
            <div class="lg:col-span-full p-0">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                    <h2 class="text-xl text-default flex items-center">
                        ...
                        <div class="px-2 text-3xl font-bold text-defalut">{{ __('messages.product') }}</div>
                    </h2>
                    <div class="flex items-center gap-x-2">
                        ...
                        @can('product.add')
                            <a href="{{ route('add.product') }}" class="bg-primary text-white py-2 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent focus:outline-hidden">
