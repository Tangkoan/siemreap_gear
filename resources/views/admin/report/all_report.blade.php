        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-6">
                    <form action="{{ route('report.orders.by_date') }}" method="post" enctype="multipart/form-data">
                        @csrf
                ...
                <!-- Search by Month -->
                <div class="bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-6">
                    <form action="{{ route('report.orders.by_month') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-6 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                        ...
                        <div class="mb-6">
                            ...
                            <select name="year_name" disabled
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-blue-400">
                ...
                <!-- Search by Year -->
                <div class="bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-6">
                    <form action="{{ route('report.orders.by_year') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-6 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
