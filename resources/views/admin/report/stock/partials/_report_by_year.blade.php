...
<div class="bg-white/80 dark:bg-gray-900/80 p-4 rounded-2xl shadow-md mb-6">
    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="flex items-center gap-4 w-full md:w-auto">
            ...
            <div class="flex items-center gap-4 w-full md:w-auto">
                <input type="number" name="year" id="year" class="form-input w-full md:w-auto bg-slate-50 dark:bg-slate-700 border-slate-200 dark:border-slate-600 rounded-lg focus:ring-red-500 focus:border-red-500" value="{{ $year }}" min="2020">
...
<div class="bg-white/80 dark:bg-gray-900/80 shadow-md rounded-2xl overflow-hidden">
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-left text-slate-500 dark:text-slate-400">
            ...
            <tbody id="report-table-body-year" class="tbody divide-y divide-slate-200 dark:divide-slate-700"></tbody>
        </table>
    </div>
