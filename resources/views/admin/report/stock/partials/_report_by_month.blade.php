...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-bold text-defalut">
        ...
        <span id="report-title-month" class="text-primary">{{ $formattedDate }}</span>
    </h2>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
    ...
    ">
        ...
        <div class="flex-grow">
            ...
            <p id="total-stock-in-month" class="text-3xl font-bold text-defalut mt-1">0</p>
        </div>
    </div>
    ...
    ">
        ...
        <div class="flex-grow">
            ...
            <p id="total-stock-out-month" class="text-3xl font-bold text-defalut mt-1">0</p>
        </div>
    </div>
...
<div class="card-dynamic-bg p-4 rounded-2xl shadow-md mb-6">
    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="flex items-center gap-4 w-full md:w-auto">
            ...
            <div class="flex items-center gap-4 w-full md:w-auto">
                <input type="month" name="month" id="month" class="form-input w-full md:w-auto card-dynamic-bg text-primary border-primary rounded-lg focus:ring-red-500 focus:border-red-500" value="{{ $month }}">
                <div class="relative w-full md:w-64">
                    ...
                    <input class="form-input w-full pl-10 card-dynamic-bg border-primary rounded-lg focus:ring-red-500 focus:border-red-500" placeholder="Search..." id="search-month" type="text" />
                </div>
            </div>
...
<div class="card-dynamic-bg shadow-md rounded-2xl overflow-hidden">
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-left text-defalut">
            ...
            <tbody id="report-table-body-month" class="tbody divide-y divide-primary"></tbody>
        </table>
    </div>
    <div id="pagination-links-month" class="p-4"></div>
</div>