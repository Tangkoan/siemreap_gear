            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <form action="{{ route('report.stock.by_day') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="date" name="date" value="{{ $today }}" readonly
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-400">
                        </div>
                ...
                <div class="bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-6">
                    <form action="{{ route('report.stock.by_month') }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="year_name" value="{{ $currentYear }}">
