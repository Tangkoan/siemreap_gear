        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4 w-full md:w-auto">
                ...
                <div class="relative w-full md:w-64">
                    ...
                    <input class="form-input w-full pl-10 bg-slate-50 dark:bg-slate-700 border-slate-200 dark:border-slate-600 rounded-lg focus:ring-blue-500 focus:border-blue-500" placeholder="Search..." id="search-day" type="text" />
                </div>
            </div>
            <a id="exportBtn-day" 
