...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-slate-500 dark:text-slate-400">{{ __('messages.total_revenue') }}</h3><p id="kpi-revenue-year" class="text-3xl font-bold text-slate-800 dark:text-white mt-2">$0.00</p></div>
        <div class="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-slate-500 dark:text-slate-400">{{ __('messages.total_orders') }}</h3><p id="kpi-orders-year" class="text-3xl font-bold text-slate-800 dark:text-white mt-2">0</p></div>
        <div class="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-slate-500 dark:text-slate-400">{{ __('messages.items_sold') }}</h3><p id="kpi-items-year" class="text-3xl font-bold text-slate-800 dark:text-white mt-2">0</p></div>
        <div class="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-slate-500 dark:text-slate-400">{{ __('messages.avg_order_value') }}</h3><p id="kpi-avg-year" class="text-3xl font-bold text-slate-800 dark:text-white mt-2">$0.00</p></div>
        <div class="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm">
            ...
            <p id="kpi-pre_orders-year" class="text-3xl font-bold text-slate-800 dark:text-white mt-2">0</p>
        </div>
    </div>
    ...
    <div class="bg-white/80 dark:bg-gray-900/80 shadow-sm rounded-2xl overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-slate-500 dark:text-slate-400">
                ...
                <tfoot id="report-table-footer-year" class="text-sm  text-slate-800 dark:text-white bg-slate-100 dark:bg-slate-700"></tfoot>
            </table>
        </div>
