...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="card-dynamic-bg p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-defalut">{{ __('messages.total_revenue') }}</h3><p id="kpi-revenue-year" class="text-3xl font-bold text-primary">$0.00</p></div>
        <div class="card-dynamic-bg p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-defalut">{{ __('messages.total_orders') }}</h3><p id="kpi-orders-year" class="text-3xl font-bold text-primary">0</p></div>
        <div class="card-dynamic-bg p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-defalut">{{ __('messages.items_sold') }}</h3><p id="kpi-items-year" class="text-3xl font-bold text-primary">0</p></div>
        <div class="card-dynamic-bg p-6 rounded-2xl shadow-sm"><h3 class="text-sm font-medium text-defalut">{{ __('messages.avg_order_value') }}</h3><p id="kpi-avg-year" class="text-3xl font-bold text-primary">$0.00</p></div>
        <div class="card-dynamic-bg p-6 rounded-2xl shadow-sm">
            ...
            <p id="kpi-pre_orders-year" class="text-3xl font-bold text-primary">0</p>
        </div>
    </div>
    ...
    <div class="card-dynamic-bg p-4 rounded-2xl shadow-sm">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-4 w-full md:w-auto">
                 <input type="number" id="year-year" class="form-input w-full md:w-auto card-dynamic-bg border-primary rounded-lg " value="{{ $year }}" min="2020" max="2099">
                <div class="relative w-full md:w-64">
                    ...
                    <input class="form-input w-full pl-10 card-dynamic-bg border-primary rounded-lg " placeholder="Search..." id="search-year" type="text" />
                </div>
            </div>
    ...
    <div class="card-dynamic-bg shadow-sm rounded-2xl overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-defalut">
                <thead class="text-xs text-defalut uppercase card-dynamic-bg">
                    <tr>
                ...
                <tfoot id="report-table-footer-year" class="text-sm  card-dynamic-bg text-defalut"></tfoot>
            </table>
        </div>
