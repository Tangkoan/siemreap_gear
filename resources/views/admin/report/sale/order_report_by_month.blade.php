            ...
            <div class="w-full flex flex-wrap justify-between items-end gap-4 mb-4">
                <div class="flex items-end gap-4">
                    ...
                    <input
                        ...
                        placeholder="Search Invoice or Customer" id="search" name="search" type="text" />
                </div>
                <div>
                    <a id="exportBtn" href="{{ route('report.orders.export.month', ['month' => $month]) }}"
    ...
    <script>
        $(document).ready(function () {
            ...
            function updateExportLink() {
                let month = $('#month').val();
                let search = $('#search').val();
                let baseUrl = "{{ route('report.orders.export.month') }}";
            ...
            // Event handler for Month Picker
            ...
            // Include the modal-handling javascript
