    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
        ...
        <div class="flex justify-between">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        ...
                        <div class="px-2">{{ __('messages.setting') }}</div>
                    </h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <a href="#" {{-- Route នេះមិនទាន់មាន ដូច្នេះដាក់ # --}}
                class="block bg-white dark:bg-slate-800 rounded-xl shadow hover:shadow-lg transition p-5 flex flex-col items-center text-center border border-slate-200 dark:border-slate-700">
                ...
                {{-- Title --}}
                <div class="mt-auto">
                    <p class="text-sm font-medium text-black dark:text-white">{{ __('messages.information_invoice') }}</p>
                </div>
            </a>
