<nav id="sidebar"
    class="static h-full nset-0  sidebar-dynamic-bg w-56 p-4 md:block hidden border-none border-slate-200/70 dark:border-slate-800 z-40 overflow-y-auto overflow-x-hidden">
