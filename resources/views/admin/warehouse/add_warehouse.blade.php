    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6">
            <div class="flex items-center mb-6">
                ...
                <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 ml-2">Add WareHouse</h2>
            </div>

            <form action="{{ route('store.warehouse') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
