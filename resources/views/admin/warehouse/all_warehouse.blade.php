                        ...
                        <div>
                            <div>
                                <button type="button"
                                    ...
                                    @if (!Auth::user()->can('warehouse.add')) disabled @endif>
                                    <a href="{{ Auth::user()->can('warehouse.add') ? route('add.warehouse') : '#' }}"
                                        class="{{ !Auth::user()->can('warehouse.add') ? 'pointer-events-none text-gray-400' : '' }}">
                                        Add WareHouse
                                    </a>
                                </button>
                            </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                function fetchData(page = 1) {
                    ...
                    $.ajax({
                        url: "{{ route('search.warehouse') }}?page=" + page,
                        type: "GET",
                        data: {
                            search: query,
                            perPage: perPage
