                ...
                <div>
                    ...
                    <form method="post" action="{{ route('condition.update') }}">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="condition_name" name="condition_name" value="{{ $condition->condition_name }}" class="w-full py-2.5 px-4 rounded-md border border-gray-300 dark:border-gray-600
                                            card-dynamic-bg text-defalut border-primary
                        ...
                        <div class="flex justify-end mt-6">
                            <button type="submit" class="bg-primary text-white font-bold py-3 px-6 rounded-md transition-colors duration-200 shadow-lg">
                                {{ __('messages.save') }}
                            </button>
                        </div>
                    </form>
