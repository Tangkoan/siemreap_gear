            ...
            <div class="lg:col-span-full p-0">
                ...
                <div class="overflow-x-auto">
                    ...
                    <div class="w-full flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 mt-1 pl-3 gap-3">
                        ...
                        <!-- Search: full width on mobile, constrained on larger -->
                        <div class="w-full sm:w-auto ml-0 sm:ml-3">
                        <div class="w-full max-w-sm min-w-[140px] relative">
                            <div class="relative">
                            {{-- ✅ Search Input --}}
                            <input
                                class="dark:bg-gray-800 dark:text-white bg-white w-full pr-11 h-10 pl-3 py-2 placeholder:text-slate-400 text-slate-700 text-sm sm:text-sm border border-slate-200 rounded transition duration-200 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md"
                            ...
                            <button
                                ...
                                stroke="currentColor" class="w-6 h-6 sm:w-8 sm:h-8 text-slate-600">
                    ...
                    <!-- Table wrapper: allow horizontal scroll on very small screens -->
                    <div class="table-wrapper overflow-auto max-h-[500px]">
                        ...
                        <thead class="bg-slate-50 dark:bg-gray-800">
                            <tr>
                            <th
                                class="p-3 sticky top-0 bg-slate-50 dark:bg-gray-800 z-10 border-b border-slate-200 dark:border-gray-700">
