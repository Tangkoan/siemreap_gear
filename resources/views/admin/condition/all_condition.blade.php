                    ...
                    <div class="w-full flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 mt-1 pl-3 gap-3">
                        ...
                        <div class="w-full sm:w-auto ml-0 sm:ml-3">
                            <div class="w-full max-w-sm min-w-[140px] relative">
                                <div class="relative">
                                    <input class="dark:bg-gray-800 dark:text-white bg-white w-full pr-11 h-10 pl-3 py-2 placeholder:text-slate-400 text-slate-700 text-sm sm:text-sm border border-slate-200 rounded transition duration-200 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md" placeholder="{{ __('messages.search') }}" id="search" name="search" type="text" />
                                    <button class="absolute h-8 w-8 right-1 top-1 my-auto px-2 flex items-center dark:bg-gray-800 bg-white rounded" type="button" aria-label="search">
                    ...
                    <div class="table-wrapper overflow-auto max-h-[500px]">
                        <table class="w-full text-left table-auto min-w-[640px] sm:min-w-full">
                            <thead class="bg-slate-50 dark:bg-gray-800">
                                <tr>
                                    <th class="p-3 sticky top-0 bg-slate-50 dark:bg-gray-800 z-10 border-b border-slate-200 dark:border-gray-700">
