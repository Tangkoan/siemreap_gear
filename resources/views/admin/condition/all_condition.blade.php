                ...
                <div class="overflow-x-auto">
                    <div class="w-full flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 mt-1 pl-3 gap-3">
                        ...
                        <div class="w-full sm:w-auto ml-0 sm:ml-3">
                            <div class="w-full max-w-sm min-w-[140px] relative">
                                <div class="relative">
                                    <input class="bg-white/80 dark:bg-gray-900/80 dark:text-white bg-white w-full pr-11 h-10 pl-3 py-2 placeholder:text-slate-400 text-slate-700 text-sm sm:text-sm border border-slate-200 rounded transition duration-200 ease focus:outline-none focus:border-slate-400 hover:border-slate-400 shadow-sm focus:shadow-md" placeholder="{{ __('messages.search') }}" id="search" name="search" type="text" />
                    ...
                    <div class="table-wrapper overflow-x-auto overflow-y-auto max-h-[500px] lg:max-h-none bg-white/80 dark:bg-gray-900/80 rounded-md">
                        <table class="w-full text-left table-auto min-w-[640px] sm:min-w-full">
                            <thead >
                                <tr>
                                    <th class="p-3 sticky top-0  z-10 border-b border-slate-200 dark:border-gray-700">
