    ...
    <div class=" shadow-lg border border-gray-200 bg-white/80 rounded-xl p-8 max-w-md w-full relative transform hover:scale-105 transition-transform duration-300 ease-in-out">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="login" name="login"  placeholder="Enter username"  value="user"
            ...
            <div class="mb-6 relative">
                ...
                <input type="password" id="password" name="password" placeholder="Enter password" value="User@123456"
