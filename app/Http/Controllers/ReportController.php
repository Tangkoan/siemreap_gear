...
// {
//     $date = $request->date; // Example: 2025-06-29
//     $formattedDate = date('d F Y', strtotime($date));

//     $orderDate = Order::with(['orderDetails.product'])
//         ->where('order_date', $date)
//         ->orderBy('id', 'desc')
//         ->get();

//     return view('admin.report.search_by_date', compact('orderDate', 'formattedDate'));
// }
...
public function SaleReportExport(){
