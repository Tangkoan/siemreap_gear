...
class StockController extends Controller
{
    ...
    // วางในไฟล์: app/Http/Controllers/StockController.php
...
public function adjustStock(Request $request)
{
    ...
    // --- การตรวจสอบ Logic การคืนสินค้าบางส่วน (ถูกต้องแล้ว) ---
    ...
    try {
        // ✅✅✅ START: นำ Logic การบันทึกข้อมูลกลับเข้ามา ✅✅✅
        ...
        // ✅✅✅ END: สิ้นสุด Logic การบันทึกข้อมูล ✅✅✅
    ...
    public function getReturnDetails(Request $request)
{
    ...
    if ($type === 'sale_return') {
        ...
        if ($searchTerm) $query->where('orders.invoice_no', 'like', "%$searchTerm%");
        ...
        if ($searchTerm) $query->where('purchases.invoice_no', 'like', "%$searchTerm%");
