...
class RoleController extends Controller
{
    ...
    public function searchPermission(Request $request)
    {
        ...
        $pagination = $isAll ? '<div class="text-sm text-defalut"></div>' : $permissions->links('pagination::tailwind')->toHtml();
    ...
    public function searchRoles(Request $request)
    {
        ...
        foreach ($roles as $key => $item) {
            ...
            <tr class="hover:bg-slate-50 border-b border-slate-200 dark:hover:bg-gray-700">
                ...
                <button class="text-primary dark:hover:text-blue-900  hover:text-blue-900  transition-colors duration-200  focus:outline-none">
    ...
    public function searchRolesPermission(Request $request)
    {
        ...
        foreach ($roles as $key => $item) {
            ...
            $table .= '<tr class="hover:bg-slate-50 border-b border-slate-200 ">'
                ...
                . '<td class="p-2 text-sm text-defalut">' . $item->name . '</td>'
